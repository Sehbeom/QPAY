  ...
  render() {
    return (
      <Stack.Navigator>
        ...
        />
        <Stack.Screen
          options={{ title: "거래승인번호 설정" }}
          name="acptnumset"
          component={AcptNumPage}
        />
        <Stack.Screen
          options={{ title: "거래승인번호 입력" }}
          name="EnterAcpt"
          component={EnterAcpt}
        />
        <Stack.Screen
          options={{ title: "거래승인번호 변경" }}
          name="ChangePage"
          component={ChangePage}
        />
        <Stack.Screen
          options={{ title: "거래승인번호 확인" }}
          name="CheckAcpt"
          component={CheckAcpt}
        />
        <Stack.Screen
          options={{ title: "거래승인번호 재설정" }}
          name="ResetPage"
          component={ResetPage}
        />
        <Stack.Screen
          options={{ title: "거래승인번호 변경완료" }}
          name="CompletePage"
